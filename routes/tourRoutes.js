...
router
    ...
    .patch(authController.protect, authController.restrictTo('admin', 'lead-guide'), tourController.uploadPhoto, tourController.resizeTourImages, tourController.updateTour)
